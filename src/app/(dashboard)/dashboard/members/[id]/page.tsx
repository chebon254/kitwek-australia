      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        ...
        <div className="relative px-6 py-8">
          ...
          <div className="mt-6 grid grid-cols-3 gap-5 border-t border-b border-gray-200 py-6">
            <div className="text-center">
              <span className="text-2xl font-bold text-gray-900">{member.stats?.posts || 0}</span>
              <p className="text-sm text-gray-500">Posts</p>
            </div>
            <div className="text-center">
              <span className="text-2xl font-bold text-gray-900">{member.stats?.connections || 0}</span>
              <p className="text-sm text-gray-500">Connections</p>
            </div>
            <div className="text-center">
              <span className="text-2xl font-bold text-gray-900">{member.stats?.events || 0}</span>
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-gray-600">{member.bio || 'No bio available'}</p>
          </div>
            ...
            <div className="mt-2 flex items-center space-x-4">
              <div className="flex items-center">
                <Award className={`h-5 w-5 ${
                  member.membershipStatus === 'ACTIVE' ? 'text-green-500' : 'text-gray-400'
                } mr-2`} />
