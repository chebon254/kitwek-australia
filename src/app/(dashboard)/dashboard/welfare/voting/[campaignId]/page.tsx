...
export default function WelfareVotingCampaignPage({
  params,
}: {
  ...
  const handleVote = async () => {
    ...
    try {
      const response = await fetch(`/api/welfare/voting/${campaignId}/vote`, {
        method: "POST",
      ...
      if (response.ok) {
        setSuccess(true);
        setTimeout(() => {
          router.push(`/dashboard/welfare/voting/${campaignId}/results`);
        }, 2000);
      } else {
        ...
        <div className="py-6">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Thank you for participating in the welfare voting process. Your vote has
              been recorded.
            </p>
  ...
  const alreadyVoted = campaign.hasUserVoted;
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {alreadyVoted && (
            <div className="mb-6 bg-green-50 border border-green-200 rounded-md p-4">
              <div className="flex">
                <AlertCircle className="h-5 w-5 text-green-400 mr-3 mt-0.5" />
                <div>
                  <h3 className="text-sm font-medium text-green-800">
                    You Have Already Voted
                  </h3>
                  <p className="mt-1 text-sm text-green-700">
                    You have already cast your vote in this campaign. You can view the results below.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              {alreadyVoted ? "Candidates" : "Select Your Candidate"}
            </h2>
            ...
            {campaign.candidates.map((candidate) => (
              <div
                ...
                className={`bg-white rounded-lg border-2 p-6 ${
                  alreadyVoted && campaign.userVotedFor === candidate.id
                    ...
                    : "border-gray-200"
                } ${!isVotingActive() || alreadyVoted ? "opacity-70" : ""}`}
                onClick={() =>
                  isVotingActive() && !alreadyVoted && setSelectedCandidate(candidate.id)
                }
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-grow">
                    <div className="flex items-center justify-between">
                      ...
                      {!alreadyVoted && selectedCandidate === candidate.id && (
