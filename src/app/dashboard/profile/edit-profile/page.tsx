...
const profileSchema = z.object({
  ...
  profession: z.string().max(100, 'Profession must be less than 100 characters'),
  twitter: z.string().url('Must be a valid URL').or(z.string().length(0)).optional(),
  instagram: z.string().url('Must be a valid URL').or(z.string().length(0)).optional(),
  facebook: z.string().url('Must be a valid URL').or(z.string().length(0)).optional(),
  youtube: z.string().url('Must be a valid URL').or(z.string().length(0)).optional(),
